...
describe CopywritingHelper do
  ...
  context "usage" do
    ...
    it "it should allow you to set the value using a block" do
      ...
      pharse = Refinery::CopywritingPhrase.where(:name => "test block").first
    ...
    it "it should allow you to set default options with copywriting_options block" do
      ...
      Refinery::CopywritingPhrase.where(:name => "test with default scope").scope.should == 'default_scope'
    end
    ...
    it "it should allow you to overwrite the default options set with copywriting_options block" do
      ...
      Refinery::CopywritingPhrase.where(:name => "test without default scope").scope.should == 'without_default_scope'
    end
    ...
    it "it should clear the default options after copywriting_options block" do
      ...
      Refinery::CopywritingPhrase.where(:name => "test outside default scope").scope.should_not == 'default_scope'
    end
